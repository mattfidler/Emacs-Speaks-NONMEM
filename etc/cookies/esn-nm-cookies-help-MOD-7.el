...
(defvar esn-records-help-MOD-7 '(
		...
		("NPARAMETERS=" "NPARAMETERS=n3\n Number  of  basic PK parameters.  Default: The number of basic PK parameters defined in the $PK  abbreviated  code.   May  also  be coded  NPARAMS.   May  be  0  with  the general non-linear models (ADVAN6, ADVAN8, ADVAN9, and ADVAN13).")
		("NEQUILIBRIUM=" "NEQUILIBRIUM=n2\n Number of equilibrium compartments.  Default: 0")
		("NCOMPARTMENTS=" "NCOMPARTMENTS=n1\n Total  number  of compartments other than the output compartment. Default: the number of COMPARTMENT options.  May  also  be  coded NCM or NCOMPS.")
)

"* $MODEL help for NONMEM 7")

(provide 'esn-records-help-MOD-7)

(provide 'esn-nm-cookies-help-MOD-7)
