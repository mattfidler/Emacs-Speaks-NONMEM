...
(defvar esn-records-help-SUB-5 '(
		...
		("SUBROUTINES=" "SUBROUTINES=[DP,LIBRARY]\n Specifies the kind of subroutines to be included  in  the  NONMEM executable (SP, DP, LIBRARY). See subroutine.")
)

"* $SUBROUTINES help for NONMEM 5")

(provide 'esn-records-help-SUB-5)

(provide 'esn-nm-cookies-help-SUB-5)
