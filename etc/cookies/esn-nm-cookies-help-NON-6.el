...
(defvar esn-records-help-NON-6 '(
		...
		("MARGINALS" "MARGINALS\n Requests that marginal cumulatives  be  obtained  (the  default). These values are found in NONMEM common ROCM18.")
)

"* $NONPARAMETRIC help for NONMEM 6")

(provide 'esn-records-help-NON-6)

(provide 'esn-nm-cookies-help-NON-6)
