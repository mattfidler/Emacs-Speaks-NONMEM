...
(defvar esn-records-help-SCA-6 '(
		...
		("TO=" "TO=n2\n n2 is the number of the last data record which  may  \"contribute\" to the scatterplot.  Default: n2 is n1+899.")
		...
		("FIRSTONLY" "FIRSTONLY\n Only the first data record from each individual record  may  contribute a point to the scatterplot. ")
...
"* $SCATTERPLOT help for NONMEM 6")

(provide 'esn-records-help-SCA-6)

(provide 'esn-nm-cookies-help-SCA-6)
